...
# raw_documents = WikipediaLoader(query="Education in the Middle East and North Africa").load()
# print(raw_documents)
...
# Test it out - parse through entity:
# res = entity_chain.invoke(
#     {"question": "Where is Palestine located in Middle East?."}
# ).names
# print(res)
...
# print(structured_retriever("Where is Gaza?"))
...
res_simple = chain.invoke(
    {
        "question": "How did Israels blockade impact the education in Gaza?",
    }
)
